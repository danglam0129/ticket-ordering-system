...
import com.ticket.ordering.system.payment.service.domain.valueobject.CreditHistoryId;
import com.ticket.ordering.system.payment.service.domain.valueobject.TransactionType;
...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    public PaymentEvent validateAndInitiatePayment(Payment payment,
        ...
        if (failureMessages.isEmpty()) {
            ...
            log.info("Payment initiation failed for order id: {}", getOrderId(payment));
    ...
    public PaymentEvent validateAndCancelPayment(Payment payment,
        ...
        if (failureMessages.isEmpty()) {
            ...
            log.info("Payment cancellation failed for order id: {}", getOrderId(payment));
            payment.updateStatus(PaymentStatus.FAILED);
            return new PaymentFailedEvent(payment, ZonedDateTime.now(ZoneId.of(UTC)), failureMessages,
                    paymentFailedEventPublisher);
        }
    ...
    private String getOrderId(Payment payment) {
        return payment.getOrderId() == null ? "unknown" : payment.getOrderId().getValue().toString();
    }
}
