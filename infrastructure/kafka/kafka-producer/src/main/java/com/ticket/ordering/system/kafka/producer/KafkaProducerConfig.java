...
import com.ticket.ordering.system.kafka.config.data.KafkaProducerConfigData;
...
public class KafkaProducerConfig<K extends Serializable, V> {
    ...
    public Map<String, Object> producerConfig() {
        ...
        props.put("spring.json.add.type.headers", kafkaProducerConfigData.getAddTypeInfoHeaders());
        return props;
    }
