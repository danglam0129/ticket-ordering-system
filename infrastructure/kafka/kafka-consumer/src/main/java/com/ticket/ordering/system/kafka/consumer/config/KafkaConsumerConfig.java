package com.ticket.ordering.system.kafka.consumer.config;

import com.ticket.ordering.system.kafka.config.data.KafkaConfigData;
import com.ticket.ordering.system.kafka.config.data.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put("spring.json.trusted.packages", kafkaConsumerConfigData.getTrustedPackages());
        props.put("spring.json.use.type.headers", kafkaConsumerConfigData.getUseTypeHeaders());
        return props;
    }
